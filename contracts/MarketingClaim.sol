...
contract MarketingClaim is VestingCore {
    uint256 public onListingAvailableRatio = 5;
    uint256 public cliffTime = 30 days;
    uint256 public vestingTime = 740 days;
    ...
    function claimAvailable(address addr) public view returns (uint256) {
        ...
        return _claimAvailable(
            ...
            10**ratioDecimal - onListingAvailableRatio                      // claimRatio
        );
    }
